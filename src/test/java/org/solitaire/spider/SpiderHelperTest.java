...
class SpiderHelperTest {
    ...
    public void test_build() {
        ...
        assertEquals(6, spider.getBoard().get(0).size());
        assertEquals(5, spider.getBoard().get(4).size());
        assertEquals("5:3s", spider.getBoard().get(0).get(0).toString());
        assertEquals("0:3s", spider.getBoard().get(0).get(COL_LONG - 1).toString());
        assertEquals("5:3s", spider.getBoard().get(0).get(0).toString());
        assertEquals("0:3s", spider.getBoard().get(0).get(COL_LONG - 1).toString());
        assertEquals("28:9s", spider.getBoard().get(NUM_LONG).get(0).toString());
        assertEquals("24:Ks", spider.getBoard().get(NUM_LONG).get(COL_LONG - 2).toString());
